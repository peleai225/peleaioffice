            ...
            <div className="relative w-[420px] h-[480px]">
              ...
              >
                ...
                <img
                  ...
                  alt="Professionnel africain travaillant sur un projet digital avec PeleAI"
                  className="w-full h-full object-cover"
                  loading="eager"
                  onError={(e) => {
                    // Fallback si l'image n'est pas encore uploadée
                    const el = e.currentTarget.parentElement
                    if (el) el.style.background = 'linear-gradient(135deg, #1B3A6B 0%, #0D1B2E 60%, #2E5A9C 100%)'
                    e.currentTarget.style.display = 'none'
                  }}
                />
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(13,27,46,0.65) 0%, transparent 50%)' }} />
